...
Enabled by `-Xlint:strict-unsealed-patmat`, the feature provides more accurate reporting of failures of match
exhaustivity for patterns with guards, extractors, and matches against unsealed traits.
