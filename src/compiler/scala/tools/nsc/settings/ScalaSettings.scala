...
trait ScalaSettings extends AbsScalaSettings
  ...
  protected def experimentalSettings = List[BooleanSetting](YmethodInfer, overrideObjects, overrideVars, YpartialUnification, YinductionHeuristics, YkindPolymorphism, YliteralTypes)
